...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    WHERE nama_ruangan NOT IN (
        ...
        WHERE tanggal = '$tanggal' AND (
            (sesi1 = $sesi1 AND sesi1 != '') OR 
            (sesi2 = $sesi2 AND sesi2 != '') OR 
            (sesi3 = $sesi3 AND sesi3 != '') OR
            (sesi4 = $sesi4 AND sesi4 != '') OR
            (sesi5 = $sesi5 AND sesi5 != '') OR
            (sesi6 = $sesi6 AND sesi6 != '') 
        )
    ) 
                        ...
                        <section class="pt-3 pb-2 bg-inherit">
                            <div class="container">
                                <label for="Checklist Ruangan">
                                    <span class="block font-bold mb-2 text-slate-800 after:content-['*'] after:text-pink-600 after:ml-0.5">Pilih Ruangan</span>
