<style>
 ...
 <!-- Navbar -->
 <!-- Header Start -->
 <header class="bg-white opacity-85 fixed top-0 left-0 w-full flex items-center z-10 hero ">
     <div class="container">
         <div class="flex items-center justify-between relative ">
             ...
             <div class="flex items-center px-4">
                 ...
                 <nav id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                     <ul class=" lg:flex">
                         <li class="group">
                             <a href="../index.php" class="hover:font-bold  hover:text-blue-900 text-2-xl text-dark py-3 mx-8 flex group-hover:text-primary ">Beranda</a>
                         </li>
                         ...
                         <div @click.away="open = false" class="relative" x-data="{ open: false }">
                             ...
                             <button @click="open = !open" class="hover:font-bold  hover:text-blue-900 text-2-xl text-dark py-3 mx-8 flex group-hover:text-primary ">
                                 <span>Gedung</span>
                         ...
                         <li class="group">
                             <a target="_blank" href="https://drive.google.com/file/d/11_OqzUNwCv9FVzDQQhy0KkPmHDobn0sc/view?usp=drivesdk" class="hover:font-bold  hover:text-blue-900 text-base text-dark py-3 mx-8 flex group-hover:text-primary ">Panduan</a>
                         </li>
                         <li class="group">
                             <a href="../utilitas.php" class="hover:font-bold  hover:text-blue-900 text-base text-dark py-3 mx-8 flex group-hover:text-primary ">Utilitas Ruang</a>
                         </li>
                         <li class="group">
                             <a href="../cekstatus.php" class=" hover:font-bold  hover:text-blue-900 text-base text-dark py-3 mx-8 flex group-hover:text-primary ">Cek Status</a>
                         </li>
                         <!-- <li class="group">
