...
if (isset($_POST["submitAll"])) {
  //cek apakah data berhasil di tambahkan atau tidak
  if (ubah_peminjaman_semua($_POST) >= 0) {
    echo "
        <script>
            alert('Data Berhasil Diubah!');
            window.history.back();
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Ubah Data Ajuan Peminjaman</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="foto_ktp" value="<?= $ajuan_peminjaman["foto_ktp"]; ?>">
                    <input type="hidden" name="surat_skpb" value="<?= $ajuan_peminjaman["surat_skpb"]; ?>">
                    <input type="hidden" name="surat_sarpras" value="<?= $ajuan_peminjaman["surat_sarpras"]; ?>">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input name="nama" type="text" value="<?= $ajuan_peminjaman["nama"]; ?>" class="form-control" id="nama" placeholder="Masukkan Nama Lengkap">
                        </div>

                        <div class="form-group">
                          <label for="nama_acara">Nama Kegiatan/Mata Kuliah</label> 
                          <input name="nama_acara" type="text" value="<?= $ajuan_peminjaman["nama_acara"]; ?>" class="form-control" id="nama_acara" placeholder="Masukkan Nama Kegiatan/Mata Kuliah">
                        </div>

                        <div class="form-group">
                          <label for="nrp">NIP/NPP/NRP</label>
                          <input name="nrp" type="text" value="<?= $ajuan_peminjaman["nrp"]; ?>" class="form-control" id="nrp" placeholder="Masukkan NIP/NPP/NRP">
                        </div>

                        <div class="form-group">
                          <label for="whatsapp">Nomor Whatsapp</label>
                          <input name="whatsapp" type="text" value="<?= $ajuan_peminjaman["whatsapp"]; ?>" class="form-control" id="whatsapp" placeholder="Masukkan Nomor Whatsapp">
                        </div>
                        ...
                        <?php
                          ...
                          $query = "SELECT nama_unit FROM unit_departemen";
                          ...
                          while ($row = mysqli_fetch_assoc($result)) {
                            $unit_values[] = $row["nama_unit"];
                          }

                        ?>

                          <div class="form-group">
                            <label for="unit_departemen">Unit/Departemen</label>
                            <select name="unit_departemen" class="custom-select form-control rounded">
                              <option value="" disabled selected hidden>Pilih Unit/Departemen</option>

                              <?php
                              foreach ($unit_values as $value) {
                                $selected = ($value == $ajuan_peminjaman["unit_departemen"]) ? "selected" : "";
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input name="foto_ktp" type="file" value="<?= $ajuan_peminjaman["foto_ktp"]; ?>" class="form-control" id="foto_ktp" placeholder="Upload KTP/KTM">
                    </div>

                    <div class="form-group">
                      <label for="surat_skpb">Surat SKPB</label>
                      <input name="surat_skpb" type="file" value="<?= $ajuan_peminjaman["surat_skpb"]; ?>" class="form-control" id="surat_skpb" placeholder="Upload Surat SKPB">
                    </div>

                    <div class="form-group">
                      <label for="surat_sarpras">Surat Sarpras</label>
                      <input name="surat_sarpras" type="file" value="<?= $ajuan_peminjaman["surat_sarpras"]; ?>" class="form-control" id="surat_sarpras" placeholder="Upload Surat Sarpras">
                    </div>
                  ...
                  <div class="card-body row">
                      <div class="col-6">
                          <button type="submit" name="submit" class="btn btn-primary w-70">Ubah untuk hanya yang dipilih</button>
                      </div>
                      <div class="col-6">
                          <button type="submit" name="submitAll" class="btn btn-primary w-100">Ubah untuk semua dengan kode peminjaman <?= $ajuan_peminjaman['kode_peminjaman']; ?></button>
                      </div>
                  </div>
