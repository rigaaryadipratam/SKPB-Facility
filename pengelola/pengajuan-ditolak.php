...
$pengajuan_semua = query("SELECT * FROM pengajuan2 WHERE status ='Ditolak'");

// if (isset($_POST["cari"])) {
//   $pengajuan_semua = cari_ditolak($_POST["keyword"]);
          ...
          <div class="col-14">
            <div class="card">
              <div class="card-header mb-5">
                <h3 class="card-title" colspan="14">Tabel Peminjaman Ruangan <span class="font-weight-bold">(Ditolak)</span></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                echo "
                    <script>
                        ...
                        document.location.href = 'pengajuan-ditolak.php';
                    </script>
                    ";
                <?php die; ?>
                <?php endif; ?>  
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><span class="badge badge-<?php if ($row['status'] == 'Terverifikasi') {
                                                                                echo 'success';
