...
$unit = query("SELECT * FROM unit_departemen WHERE id =$id")[0];


//cek apakah tombol submit sudah di tekan atau belum
if (isset($_POST["submit"])) {
  //cek apakah data berhasil di tambahkan atau tidak
  if (ubah_unit($_POST) >= 0) {
    echo "
        <script>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Ubah Data Unit/Departemen</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
                  ...
                  <form action="" method="post">
                    <input type="hidden" name="id" value="<?= $unit["id"]; ?>">
                        ...
                        <div class="form-group">
                          ...
                          <input name="nama_unit" type="text" value="<?= $unit["nama_unit"]; ?>" class="form-control" id="nama_unit" placeholder="Masukkan Nama Unit/Departemen">
                        </div>
