...
if(isset($_POST["submit"]) ){
  ...
  if(tambah_kelas($_POST) > 0){
      echo "
          <script>
              alert('Data Kelas SKPB Berhasil Ditambahkan!');
              window.history.back();
          </script>
      ";
  } else{
      echo "
          <script>
              alert('Data Kelas SKPB Gagal Ditambahkan!');
              window.history.back();
          </script>
      ";
  }
          ...
          <div class="col-14">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" colspan="14">Tabel Daftar Mata Kuliah SKPB <span class="text-primary font-weight-bold">(All)</span></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="ubah-kelas.php?id=<?= $row["id"]; ?>" class="btn btn-sm btn-success">
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Tambah Kelas SKPB</h4>
            ...
            <form method="post" action="" enctype="multipart/form-data">
              <div class="modal-body row g-3">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="nama_acara">Nama Mata Kuliah<span class="required-sign">*</span></label>
                      <input name="nama_acara" type="text" class="form-control" id="nama_acara" placeholder="Masukkan Nama Mata Kuliah" required>
                    </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a href="hapus-peminjaman.php?id=${id}" class="btn btn-primary">Ya</a>
